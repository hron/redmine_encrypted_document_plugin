namespace :redmine do
 namespace :encrypted_documents do
    desc <<-DESC
Initialize GnuPG home and generate private & public keys pair.
    ...
    task :init => :environment do
      ...
      if File.directory? ENV['GNUPGHOME']
        ...
        File.open( "#{ENV['GNUPGHOME']}/gpg.conf", "w") do |gpg_conf|
          gpg_conf << <<-'EOF'
# Options for GnuPG
# Copyright 1998, 1999, 2000, 2001, 2002, 2003, 2007, 2008 Free Software Foundation, Inc.
# 
